...
if($('.bouncing-balls-bg').length > 0){
var container = document.querySelector(".bouncing-balls-bg");
}
...
// new aman css start
  ...
  // ===== LEADERSHIP SLIDER (ADDED CLEANLY) =====
$leadership.on("init reInit afterChange", function (event, slick, currentSlide) {

  var i = (currentSlide ? currentSlide : 0) + 1;
  var total = slick.slideCount; // use real count
